                    ...
                    <div class="card mb-4 shadow-sm">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                <a href="{{ route('courses.uploadVideoForm', ['course' => optional($course)->id]) }}"
                                    class="btn btn-sm btn-primary">
                                    <i class="bi bi-upload"></i> Upload Video
                                </a>
                                <form
                                    action="{{ route('courses.deleteVideo', ['course' => optional($course)->id, 'video' => $video->id]) }}"
                    ...
                    <div class="card mb-4 shadow-sm">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between mt-2">
                                <a href="{{ route('courses.uploadPdfForm', ['course' => optional($course)->id]) }}"
                                    class="btn btn-sm btn-primary">
                                    <i class="bi bi-upload"></i> Upload PDF
                                </a>
                                <form
                                    action="{{ route('courses.deletePdf', ['course' => optional($course)->id, 'pdf' => $pdf->id]) }}"
