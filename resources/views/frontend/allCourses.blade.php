...
@section('content')
    <div class="font-[sans-serif] bg-gray-100">
        <div class="p-4 mx-auto lg:max-w-7xl sm:max-w-full">
            <h2 class="flex items-center justify-center text-4xl font-extrabold mb-6 text-gray-800 dark:text-neutral-500">
                Semua
                Kursus</h2>
            <h3 class="flex items-center justify-center">Dapatkan pengetahuan dari mentor berpengalaman dengan biaya yang
                terjangkau.
            </h3>
                                ...
                                <a href="{{ route('frontend.details', $course->slug) }}"
                                    ...
                                    @if ($course->youtube_thumbnail_url)
                                        <iframe width="100%" height="100%"
                                            src="{{ $course->youtube_thumbnail_url }}?autoplay=0&mute=1" frameborder="0"
                                ...
                                <div class="flex flex-col px-4 gap-[32px]">
                                    <div class="flex flex-col gap-[10px]">
                                        ...
                                        <div class="flex justify-between items-center">
                                            ...
                                            <p class="text-right text-[#6D7786]">{{ $course->enrollments->count() }}
                                                students</p>
                                        </div>
                                    </div>
                                    <div class="flex justify-between items-center">
                                        @auth
                                            ...
                                            @else
                                                ...
                                                <p class="font-bold text-lg text-[#1F2937]">Rp
